...
func (x *VerifyCodeResponse) GetResetToken() string {
	if x != nil {
		return x.ResetToken
	}
	return ""
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\x0fRegenerateToken\x12\x1e.sso.v3.RegenerateTokenRequest\x1a\x1f.sso.v3.RegenerateTokenResponse\x12X\n" +
...
var file_sso_sso_proto_goTypes = []any{
	...
	(*CreateNewPasswordRequest)(nil),  // 10: sso.v3.CreateNewPasswordRequest
	(*CreateNewPasswordResponse)(nil), // 11: sso.v3.CreateNewPasswordResponse
	(*SendCodeRequest)(nil),           // 12: sso.v3.SendCodeRequest
	(*SendCodeResponse)(nil),          // 13: sso.v3.SendCodeResponse
	(*VerifyCodeRequest)(nil),         // 14: sso.v3.VerifyCodeRequest
	(*VerifyCodeResponse)(nil),        // 15: sso.v3.VerifyCodeResponse
}
var file_sso_sso_proto_depIdxs = []int32{
	...
	10, // 4: sso.v3.Auth.CreateNewPassword:input_type -> sso.v3.CreateNewPasswordRequest
	8,  // 5: sso.v3.Auth.Logout:input_type -> sso.v3.LogoutRequest
	12, // 6: sso.v3.Code.SendCode:input_type -> sso.v3.SendCodeRequest
	14, // 7: sso.v3.Code.VerifyCode:input_type -> sso.v3.VerifyCodeRequest
	1,  // 8: sso.v3.Auth.Login:output_type -> sso.v3.LoginResponse
	3,  // 9: sso.v3.Auth.Register:output_type -> sso.v3.RegisterResponse
	5,  // 10: sso.v3.Auth.IsAdmin:output_type -> sso.v3.IsAdminResponse
	7,  // 11: sso.v3.Auth.RegenerateToken:output_type -> sso.v3.RegenerateTokenResponse
	11, // 12: sso.v3.Auth.CreateNewPassword:output_type -> sso.v3.CreateNewPasswordResponse
	9,  // 13: sso.v3.Auth.Logout:output_type -> sso.v3.LogoutResponse
	13, // 14: sso.v3.Code.SendCode:output_type -> sso.v3.SendCodeResponse
	15, // 15: sso.v3.Code.VerifyCode:output_type -> sso.v3.VerifyCodeResponse
